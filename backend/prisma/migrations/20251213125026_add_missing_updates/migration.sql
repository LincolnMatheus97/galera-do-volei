...
INSERT INTO "new_partidas" ("bannerUrl", "cargaHoraria", "data", "descricao", "id", "limiteCheckin", "local", "moderadorId", "pixChave", "preco", "situacao", "tipo", "titulo") SELECT "bannerUrl", "cargaHoraria", "data", "descricao", "id", "limiteCheckin", "local", "moderadorId", "pixChave", "preco", "situacao", "tipo", "titulo" FROM "partidas";
DROP TABLE "partidas";
